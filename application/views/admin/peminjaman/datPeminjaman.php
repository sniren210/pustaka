    ...
    <section class="content">
        ...
        <div class="box box-solid box-primary">
          ...
          <div class="btn-group">
            <td>
             <div align ="left">
              <a  href="<?php echo base_url(); ?>Peminjaman"  class="btn btn-danger" role="button" data-toggle="tooltip" title="Data Pinjam"></i>Data Pinjam</a>
              <a  href="<?php echo base_url(); ?>peminjaman/Kembali"  class="btn btn-danger" role="button" data-toggle="tooltip" title="Data Kembali"></i>Data Kembali</a>
              </div>
           </td>
          </div>
          </div>
           ...
           <div class="box-body">
           <div class="btn-group"><a href="<?php echo base_url(); ?>peminjaman/creatPeminjaman"  class="btn btn-success" role="button" data-toggle="tooltip" title="Tambah Peminjaman"><i class="fa fa-plus"></i>Tambah Peminjaman</a></div>
          ...
          $no = 1;
            ...
            ?>
                    <tr>
                        ...
                        <?php echo 
                            '<div class="btn-group">
                            <a href="'.base_url().'peminjaman/detailPeminjaman/?id_pinjam='.$op['id_pinjam'].'" class="btn btn-info" role="button" data-toggle="tooltip" title="Detail Pinjam"><i class="fa fa-list"></i></a>&nbsp
                            </div>';
                            if($op['status']==0)
                            {
                             echo 
                             '<a href="'.base_url().'peminjaman/editPeminjaman/?id_pinjam='.$op['id_pinjam'].'" class="btn btn-warning" role="button" data-toggle="tooltip" title="Edit"><i class="fa fa-edit"></i></a>';
                            }
                            if($op['status']==1)
                            {                 
                            echo 
                            '<span data-toggle="modal" data-target="#confirm-delete" data-href="'.base_url().'peminjaman/delPeminjaman/?id_pinjam='.$op['id_pinjam'].'">
                            <a class="btn btn-danger" role="button" data-toggle="tooltip" data-placement="top" title="Hapus"><i class="fa fa-trash"></i></a>                     
                            </span>';
                            }
                            if ($op['total_buku']>0) {
                              echo 
                             '&nbsp <a href="'.base_url().'peminjaman/backPeminjaman/?id_pinjam='.$op['id_pinjam'].'" class="btn btn-warning" role="button" data-toggle="tooltip" title="Kembalikan"><i class="fa fa-share"></i></a>';
                            }
                            echo
                        '</td>
                    </tr>';?>
