    ...
    <section class="content">
      ...
      <div class="box box-solid box-primary">
        <div class="box-header with-border">
          <h3 class="box-title"><i class="fa fa-pencil"></i> <i class="fa fa-book"></i>Edit Agama</h3>
         ...
         <div class="box-body">
          ...
          <form class="form-horizontal" method="post"  action="<?php echo base_url(); ?>agama/editAgama" role="form">
              <div class="box-body">
        ...
        <td>
          <div align ="Right"> <a  href="<?php echo base_url(); ?>agama/Anggota"  class="btn btn-danger" role="button" data-toggle="tooltip" title="Kembali"></i>Back</a></div>
        </td>
        </div>
        <div class="box-footer">
