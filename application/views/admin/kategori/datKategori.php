  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box-header with-border">
       ...
       <div class="box-body">
       <div class="btn-group"><a href="<?php echo base_url(); ?>kategori/creatKategori"  class="btn btn-success" role="button" 
      ...
      $no = 1;
        ...
        ?>
                <tr>
                    ...
                    <?php echo 
                        '<div class="btn-group">
                         <a href="'.base_url().'Kategori/editkategori/?id_kategori='.$op['id_kategori'].'" class="btn btn-warning" role="button" data-toggle="tooltip" title="Edit"><i class="fa fa-edit"></i></a>
                         &nbsp&nbsp
                        <span data-toggle="modal" data-target="#confirm-delete">
                        <a class="btn btn-danger" role="button" data-toggle="tooltip" data-placement="top" title="Hapus" href="'.base_url().'Kategori/delKategori/?id_kategori='.$op['id_kategori'].'"><i class="fa fa-trash" ></i></a>
                        </span>
                    </td>
                </tr>';?>
      <?php
