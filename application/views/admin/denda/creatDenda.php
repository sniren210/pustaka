...
<div class="box box-solid box-primary">
  ...
  <form class="form-horizontal" method="post"  action="<?php echo base_url(); ?>Denda/creatDenda" role="form">
              <div class="box-body">
  ...
  <td>
    <div align ="Right"> <a  href="<?php echo base_url(); ?>Denda"  class="btn btn-danger" role="button" data-toggle="tooltip" title="Kembali"></i>Back</a></div>
  </td>
  </div>
  <div class="box-footer">
