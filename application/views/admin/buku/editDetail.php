...
<div class="box box-solid box-primary">
  ...
  <form class="form-horizontal" method="post"  action="<?php echo base_url(); ?>Buku/editDetail/?id_detail_buku=<?php echo $id_detail_buku;?>&id_buku=<?php echo $id_buku;?>" role="form">
...
<?php }?>
    ...
    <td>
    <div align ="Right"> <a  href="<?php echo base_url(); ?>Buku/detailStok/?id_buku=<?php echo $id_buku;?>"  class="btn btn-danger" role="button" data-toggle="tooltip" title="Kembali"></i>Back</a></div>
  </td>
  </div>
  <div class="box-footer">
