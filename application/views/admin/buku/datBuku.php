    ...
    <section class="content">
      ...
      <div class="box box-solid box-primary">
        <div class="box-header with-border">
         ...
         <div class="box-body">
         <div class="btn-group"><a href="<?php echo base_url(); ?>buku/creatbuku"  class="btn btn-success" role="button" data-toggle="tooltip" title="Tambah Data Buku"><i class="fa fa-plus"></i>  Tambah Data Buku</a></div>
...
<!--                       <td><?php $model->countRow(1,$op['id_buku']);?></td>
                      ...
                      <?php echo 
                          '<div class="btn-group">
                          <a href="'.base_url().'Buku/detailStok/?id_buku='.$op['id_buku'].'" class="btn btn-info" role="button" data-toggle="tooltip" title="Detail Stok"><i class="fa fa-list"></i></a>
                          </div>
                           <a href="'.base_url().'Buku/editBuku/?id_buku='.$op['id_buku'].'" class="btn btn-warning" role="button" data-toggle="tooltip" title="Edit"><i class="fa fa-edit"></i></a>
                          <span data-toggle="modal" data-target="#confirm-delete">
                          <a class="btn btn-danger" role="button" data-toggle="tooltip" data-placement="top" title="Hapus" href="'.base_url().'Buku/delBuku/?id_buku='.$op['id_buku'].'"><i class="fa fa-trash"></i></a>
                          </span>
                      </td>
                  </tr>';?>
      <?php
